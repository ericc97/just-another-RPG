...
test('should get the inventory from a player or return false', () => {
    const player = new Player('Dave');
...
test('should get the players health value', () => {
    const player = new Player('Dave');

    expect(player.getHealth()).toEqual(expect.stringContaining(player.health.toString()));
});

test('should check to see if the player is still alive or not', () => {
    const player = new Player('Dave');
...
test('should use a potion from the inventory', () => {
    const player = new Player('Dave');
